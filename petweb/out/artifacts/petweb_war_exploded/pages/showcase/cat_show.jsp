...
<div id="Container">
    ...
    <div id="main">
        ...
        <div id="center">
            <%--遍历所有的dog--%>
            <c:forEach items="${requestScope.page.items}" var="pets">
            ...
            <div id="page_nav">
                ...
                <c:if test="${requestScope.page.pageNo > 1}">
                    <a href="showcase/petsServlet?dogorcat=cat&&action=page&pageNo=1">Top</a>
                    <a href="showcase/petsServlet?dogorcat=cat&&action=page&pageNo=${requestScope.page.pageNo-1}">Last</a>
                </c:if>
                ...
                <c:forEach begin="${begin}" end="${end}" var="i">
                    ...
                    <c:if test="${i != requestScope.page.pageNo}">
                        <a href="showcase/petsServlet?dogorcat=cat&&action=page&&pageNo=${i}">${i}</a>
                    </c:if>
                </c:forEach>
                <%--页码输出的结束--%>
                ...
                <c:if test="${requestScope.page.pageNo < requestScope.page.pageTotal}">
                    <a href="showcase/petsServlet?dogorcat=cat&&action=page&pageNo=${requestScope.page.pageNo+1}">Next</a>
                    <a href="showcase/petsServlet?dogorcat=cat&&action=page&pageNo=${requestScope.page.pageTotal}">End</a>
                </c:if>
